...
source('/Users/ecor/Dropbox/R-packages/RGENERATEPREC/R/predict.PrecipitationOccurenceModel.R', chdir = TRUE)
data(trentino)
...
### predict method for 'PrecipitationOccurenceMultiSiteModel' object 
## 
prec_occurence_mes <- prec_mes>=valmin
